...
<body>
        ...
        <p>
            La solicitud de alquiler de la propiedad <b>{{$info['titulo_pub']}}</b> ha sido <b>Rechazada</b>.
        </p>
        <p>
            Esto se debe a que el propietario considera que no cumple con los requisitos necesarios para alquilar la propiedad.
            O que no se encuentra disponible en el momento de la solicitud.
        </p>
        <p>
