                    ...
                    <div class="container py-4">
                        <div class="row">
                            <div class="col-lg-7 mx-auto d-flex justify-content-center flex-column">
                                <h3 class="text-center">Hola {{$usuario->name}}</h3>
{{--                                <div class="bg-green-">--}}
                                    <p class="lead mb-0 text-center m-4">
                                        Necesitamos que completes los siguientes campos para asi
                                        poder habilitar algunas funcionalidades en nuestra plataforma.<br>
                                        Y así ofrecerte la mejor experiencia posible
                                    </p>
{{--                                </div>--}}
                                <form role="form" id="data-form" action="{{route('datosExtraUsuarios.store')}}" method="POST" autocomplete="off" >
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="input-group input-group-dynamic mb-4">
                                                    ...
                                                    <input class="form-control" type="number" min="9999999" max="99999999" name="dni" id="inputDNI">
                                                </div>
                                            </div>
...
{{--                                            <div class="form-row shadow-none p-2 mb-5 bg-light rounded mt-5">--}}
                                                <select class="multisteps-form__select form-control" id="inputProvincia">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 ps-2">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <input type="text" class="form-control" name="calle_dom" id="inputCUIT">
                                                    {{--                                                    <input type="number" class="form-control" name="cuit" id="inputCUIT">--}}
                                                    {{--                                                    <input type="number" class="form-control" name="cuit" id="inputCUIT">--}}
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-2">
                                                <div class="input-group input-group-dynamic">
                                                    ...
                                                    <input type="number" class="form-control" name="altura_dom" id="inputCUIT">
                                                    {{--                                                    <input type="number" class="form-control" name="cuit" id="inputCUIT">--}}
                                                    {{--                                                    <input type="number" class="form-control" name="cuit" id="inputCUIT">--}}
                                                </div>
                                            </div>
...
{{--                                            </div>--}}
                                            <div class="col-md-12">
                                                <button type="submit" class="btn bg-gradient-dark w-100">Registrar datos</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
